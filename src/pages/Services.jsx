...
const SECTIONS = [
  ...
  },
  {
    ...
    points: [
      ...
      'Backup for servers, endpoints and cloud data, with scheduled test restores logged and reported',
      'Secure file sharing and permissions set up so the right people see the right things, nothing more',
